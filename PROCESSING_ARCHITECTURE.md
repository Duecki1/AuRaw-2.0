...
- **Tone**: reduced-resolution tone guide, histogram, and global scene statistics.
- **Output**: Develop adjustments and display rendering.
...
1. A headless proxy pipeline computes global tone statistics.
