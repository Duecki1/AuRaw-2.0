...
AuRaw is licensed under GPL-3.0-or-later; see [COPYING](COPYING). Code adapted
...
See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) and the complete resolved
Rust dependency terms in [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md).
