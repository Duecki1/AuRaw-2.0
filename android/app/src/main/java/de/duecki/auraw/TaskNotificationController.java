...
final class TaskNotificationController {
    ...
    private static final String CHANNEL_ID = "auraw_task_progress";
    ...
    private static final String PREFERENCES = "auraw-notifications";
    ...
    private void post(PendingUpdate update) {
        ...
        Intent reopenIntent = new Intent(activity, AuRawActivity.class)
        ...
        String expandedText = detailText
                + "\nKeep AuRaw open in the foreground until this operation finishes. Leaving or closing the app may stop it.";
