...
This document is a design investigation only. No Android notification, service,
WorkManager, UIDT, or process-lifecycle code was added as part of this follow-up.
...
1. Add a notification-only progress mirror and permission UX without changing
   execution ownership.
