...
use crate::pipeline::{
    ...
    ExposureParams, GlowEffectSettings, LoadedRaw, LocalMask, MaskCombineMode, MaskComponent,
    MaskEffect, MaskEffectCategory, MaskGeometry, MaskKind, NeonEffectSettings,
