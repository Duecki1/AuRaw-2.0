        ...
        crate::ui::theme::toolbar_row(ui, |ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ...
                let clear = crate::ui::icons::phosphor_icon_button_enabled(
                    ui,
                    app.inpaint.strokes.iter().any(|stroke| stroke.kind == active_tool),
        ...
        crate::ui::theme::section_card(ui, "Tool", |ui| {
            ...
            if app.inpaint.tool != previous_tool {
                ...
                app.inpaint.source_pick_active =
                    app.inpaint.tool.requires_source() && app.inpaint.source_anchor.is_none();
            }
            let help = match app.inpaint.tool {
                UiInpaintTool::Remove => {
        ...
        crate::ui::theme::section_card(ui, format!("{} strokes", active_tool.label()), |ui| {
            ...
            if visible_strokes.is_empty() {
                ...
                for (tool_index, index) in visible_strokes.iter().copied().enumerate().rev() {
                    let dab_count = app.inpaint.strokes[index].dab_count;
                    crate::ui::theme::toolbar_row(ui, |ui| {
                        ...
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ...
                            let _ = crate::ui::icons::phosphor_icon_button_enabled(
                                ui,
                                true,
            ...
            if app.preview.gpu_pipeline.is_none() {
                ui.add_space(8.0);
                ui.colored_label(ui.visuals().warn_fg_color, "Open a RAW image to use Inpainting.");
            }
        });
    }
}
