...
pub(in crate::ui::library) fn local_folders_available(app: &AurawApp) -> bool {
    app.library.root_folder.is_some()
}

pub(in crate::ui::library) fn can_create_local_folder(app: &AurawApp) -> bool {
...
pub(in crate::ui::library) fn show_page_dialogs(_ui: &mut Ui, _app: &mut AurawApp) {}
