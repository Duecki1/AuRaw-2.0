...
@group(0) @binding(20) var dual_green_write: texture_storage_2d<rgba16float /* CALIBRAW_WORK_FORMAT */, write>;
@group(0) @binding(21) var dual_green_read: texture_2d<f32>;
@group(0) @binding(22) var dual_low_write: texture_storage_2d<rgba16float /* CALIBRAW_WORK_FORMAT */, write>;
