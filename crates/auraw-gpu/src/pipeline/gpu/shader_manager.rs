use super::{
    ...
    SHADER_MASK_EFFECTS_SHARED, SHADER_MASK_GLOW, SHADER_MASK_LIGHT_RAYS, SHADER_MASK_NEON,
    SHADER_MASK_PIXELATE, SHADER_NOISE, SHADER_NOISE_CA_FINISH, SHADER_PROFILE,
