...
#[cfg(test)]
mod tests {
    use super::{sigmoid_probability, validate_birefnet_output_shape, BiRefNetQuality, Letterbox};

    #[test]
    fn letterbox_preserves_landscape_aspect_ratio() {
        let box_ = Letterbox::for_image(6000, 4000, 1024, 1024).unwrap();
