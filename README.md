...
the separate SAM 2.1 Hiera Tiny encoder and prompt decoder ONNX files, followed automatically by the same ViTMatte refiner. Landscape selection uses a pinned quantized MaskFormer Swin-Base ADE20K ONNX file. On Linux,
